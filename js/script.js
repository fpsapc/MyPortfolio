...
const projects = [
  ...
  },
  {
    id: 'bg-pro2',
    name: 'Book Store',
    description: 'It is an online library where user can also add new books and also rate existing books.',
    featuredImage: './img/bookstore.JPG',
    technologies: ['React', 'JavaScript', 'Redux',],
    seeProject: 'See Project',
    linkLive: '<a href="https://book-store-an0a.onrender.com/" target="blank">See Live</a>',
    linkSource: '<a href="https://github.com/fpsapc/bookstore" target="blank">See Source</a>',
  },
  {
    id: 'bg-pro3',
